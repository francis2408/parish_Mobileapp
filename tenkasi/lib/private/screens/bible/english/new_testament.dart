...
class NewTestamentScreen extends StatefulWidget {
  const NewTestamentScreen({Key? key}) : super(key: key);

  @override
  State<NewTestamentScreen> createState() => _NewTestamentScreenState();
}

class _NewTestamentScreenState extends State<NewTestamentScreen> {
