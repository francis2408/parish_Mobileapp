...
import 'package:tenkasi/private/screens/authentication/verification_code.dart';
    ...
    if (userNameController.text.isNotEmpty && userNameController.text != '' &&
      ...
      if (response.statusCode == 200) {
        ...
        if (datas["status"] == true) {
          setState(() {
            _isLoading = false;
            Navigator.of(context).pushReplacement(CustomRoute(widget: VerificationScreen(value: userEmail, type: false,)));
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: <BoxShadow>[
                      BoxShadow(
                        color: menuPrimaryColor.withOpacity(0.5),
                        spreadRadius: 0.3,
                        blurRadius: 3,
