...
class SaintsDetailsScreen extends StatefulWidget {
  final String image;
  final String name;
  final String birth;
  final String death;
  ...
  const SaintsDetailsScreen({Key? key, required this.image, required this.name, required this.birth, required this.death, required this.feastDay, required this.feastMonth, required this.description}) : super(key: key);

  @override
  State<SaintsDetailsScreen> createState() => _SaintsDetailsScreenState();
}

class _SaintsDetailsScreenState extends State<SaintsDetailsScreen> {
