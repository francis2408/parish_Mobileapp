...
class _AnnouncementScreenState extends State<AnnouncementScreen> {
  ...
  getNewsData() async {
    ...
    request.body = json.encode({
      "params": {
        "filter": "[['type','=','Announcement'],['parish_id','=', ${int.parse(parishID)}]]",
                                          ...
                                          children: <Widget>[
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                mainAxisAlignment: MainAxisAlignment.end,
                                                children: [
                                                  const Icon(Icons.access_time_filled, color: hiLightColor, size: 20,),
                                            ...
                                            Expanded(
                                              child: SingleChildScrollView(
                                                child: Padding(
                                                  ...
                                                  child: Html(
                                                    data: announcement[index]['description'],
                                                    style: {
                                                      'p': Style(
