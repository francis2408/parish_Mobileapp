...
import 'package:tenkasi/private/screens/bcc/bcc_familys.dart';
import 'package:tenkasi/private/screens/bcc/bcc_members.dart';
...
class _BCCScreenState extends State<BCCScreen> {
  ...
  getBccData() async {
    ...
    request.body = json.encode({
      "params": {
        "filter": "[['parish_id','=', ${int.parse(parishID)}]]",
                                  ...
                                  child: ListTile(
                                    ...
                                    subtitle: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            results[index]['parish_family_count'] != '' && results[index]['parish_family_count'] != null && results[index]['parish_family_count'] != 0 ? Container(
                                            ...
                                            results[index]['parish_members_count'] != '' && results[index]['parish_members_count'] != null && results[index]['parish_members_count'] != 0 ? Container(
                                              padding: const EdgeInsets.only(top: 5, bottom: 5, left: 8, right: 8),
                                              decoration: BoxDecoration(
                                                borderRadius: BorderRadius.circular(5),
                                ...
                                child: Padding(
                                  ...
                                  child: ListTile(
                                    leading: Container(
                                      ...
                                      child: Center(
                                          child: IconButton(
                                            icon: Image.asset("assets/icons/anbiyam.png"),
                                            iconSize: 60,
                                            onPressed: () {},
                                          )
                                      ),
                                    ...
                                    subtitle: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            bccData[index]['parish_family_count'] != '' && bccData[index]['parish_family_count'] != null && bccData[index]['parish_family_count'] != 0 ? Container(
                                              padding: const EdgeInsets.only(top: 5, bottom: 5, left: 8, right: 8),
                                              decoration: BoxDecoration(
                                                borderRadius: BorderRadius.circular(5),
                                                color: customBackgroundColor1,
                                            ...
                                            bccData[index]['parish_members_count'] != '' && bccData[index]['parish_members_count'] != null && bccData[index]['parish_members_count'] != 0 ? Container(
                                              padding: const EdgeInsets.only(top: 5, bottom: 5, left: 8, right: 8),
                                              decoration: BoxDecoration(
                                                borderRadius: BorderRadius.circular(5),
                                                color: customBackgroundColor2,
