...
import 'package:tenkasi/private/screens/subscription/subscription.dart';
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  members['reference'] != '' && members['reference'] != null ? Text(
                                    members['reference'],
                                    style: GoogleFonts.secularOne(fontSize: size.height * 0.018, color: blackColor,),
                                  ) : Container(),
          ...
          child: GestureDetector(
            onTap: () async {
              String refresh = await Navigator.push(context,
                  MaterialPageRoute(builder: (context) => SubscriptionScreen(name: members['name'])));
              if(refresh == 'refresh') {
                changeData();
              }
            },
