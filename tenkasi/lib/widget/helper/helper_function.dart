...
class HelperFunctions {
  ...
  static setFamilyDataSF(isFamilyData) async {
    SharedPreferences sf = await SharedPreferences.getInstance();
    String jsonString = jsonEncode(isFamilyData);
    return sf.setString('isFamilyKey', jsonString);
    // return sf.setStringList('isFamilyKey', isFamilyData);
  }
}
