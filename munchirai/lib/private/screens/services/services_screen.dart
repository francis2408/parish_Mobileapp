...
class _ServicesScreenState extends State<ServicesScreen> {
  ...
  String disclaimer = "Munchirai Punitha Arickiya Matha (MPAM) church is not lible for any damages that may occur when people use these services. Use at Your Own Risk.";
  List service = [];
  ...
  getServicesData() async {
    var request = http.Request('GET', Uri.parse('$baseUrl/public/$parishID/parish_service_info'));
                        ...
                        children: [
                          Flexible(
                            child: RichText(
                              ...
                              text: TextSpan(
                                  text: "Munchirai Punitha Arickiya Matha (MPAM)",
                      ...
                      children: [
                        SlideFadeAnimation(
                          ...
                          child: ListView.builder(
                            ...
                            itemCount: service.length, // Update the itemCount to 2 for two expansion tiles
                                ...
                                children: [
                                  Card(
                                    ...
                                    child: ExpansionTile(
                                      ...
                                      title: Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            service[index]['members'].length == 0 ? Container() : Text(
                                              '( ${service[index]['members'].length} )',
                                              style: GoogleFonts.roboto(
                                                fontSize: size.height * 0.02,
                                                color: textExpandColor,
                                                fontWeight: FontWeight.bold,
                                      ...
                                      children: [
                                        service[index]['members'].isNotEmpty ? ListView.builder(
                                          key: Key('builder ${selected2.toString()}'),
                                          shrinkWrap: true,
                                          physics: const NeverScrollableScrollPhysics(),
                                          itemCount: isCategoryExpanded ? service[index]['members'].length : 0, // Update the itemCount to 2 for two expansion tiles
                                          itemBuilder: (BuildContext context, int indexs) {
                                            return Column(
                                              children: [
                                                Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      GestureDetector(
                                                        onTap: () {
                                                          service[index]['members'][indexs]['image'] != '' ? showDialog(
                                                            context: context,
                                                            builder: (BuildContext context) {
                                                              return Dialog(
                                                                child: Image.network(service[index]['members'][indexs]['image'], fit: BoxFit.cover,),
                                                              );
                                                            },
                                                          ) : showDialog(
                                                            context: context,
                                                        ...
                                                        child: Container(
                                                          ...
                                                          decoration: BoxDecoration(
                                                            ...
                                                            image: DecorationImage(
                                                              fit: BoxFit.contain,
                                                              image: service[index]['members'][indexs]['image'] != null && service[index]['members'][indexs]['image'] != ''
                                                                  ? NetworkImage(service[index]['members'][indexs]['image'])
                                                            ...
                                                            children: [
                                                              Row(
                                                                ...
                                                                children: [
                                                                  Flexible(
                                                                    child: Text(
                                                                      service[index]['members'][indexs]['name'],
                                                              ...
                                                              Row(
                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                children: [
                                                                  service[index]['members'][indexs]['mobile'] != '' && service[index]['members'][indexs]['mobile'] != null && service[index]['members'][indexs]['mobile'] != false ? IntrinsicHeight(
                                                                    child: (service[index]['members'][indexs]['mobile']).split(',').length != 1 ? Row(
                                                                      children: [
                                                                        GestureDetector(
                                                                          onTap: () {
                                                                            showDialog(
                                                                                  ...
                                                                                  content: Row(
                                                                                    ...
                                                                                    children: [
                                                                                      IconButton(
                                                                                        onPressed: () {
                                                                                          Navigator.pop(context);
                                                                                          callAction((service[index]['members'][indexs]['mobile']).split(',')[0].trim());
                                                                                        },
                                                                                      ...
                                                                                      IconButton(
                                                                                        onPressed: () {
                                                                                          Navigator.pop(context);
                                                                                          smsAction((service[index]['members'][indexs]['mobile']).split(',')[0].trim());
                                                                                        },
                                                                                      ...
                                                                                      IconButton(
                                                                                        onPressed: () {
                                                                                          Navigator.pop(context);
                                                                                          whatsappAction((service[index]['members'][indexs]['mobile']).split(',')[0].trim());
                                                                                        },
                                                                          ...
                                                                          child: Text(
                                                                            (service[index]['members'][indexs]['mobile']).split(',')[0].trim(),
                                                                        ...
                                                                        GestureDetector(
                                                                                  ...
                                                                                  content: Row(
                                                                                    ...
                                                                                    children: [
                                                                                      IconButton(
                                                                                        onPressed: () {
                                                                                          Navigator.pop(context);
                                                                                          callAction((service[index]['members'][indexs]['mobile']).split(',')[1].trim());
                                                                                        },
                                                                                        icon: const Icon(Icons.phone),
                                                                                        color: callColor,
                                                                                      ),
                                                                                      IconButton(
                                                                                        onPressed: () {
                                                                                          Navigator.pop(context);
                                                                                          smsAction((service[index]['members'][indexs]['mobile']).split(',')[1].trim());
                                                                                        },
                                                                                        icon: const Icon(Icons.message),
                                                                                        color: smsColor,
                                                                                      ),
                                                                                      IconButton(
                                                                                        onPressed: () {
                                                                                          Navigator.pop(context);
                                                                                          whatsappAction((service[index]['members'][indexs]['mobile']).split(',')[1].trim());
                                                                                        },
                                                                                        icon: SvgPicture.asset('assets/icons/whatsapp.svg', color: whatsAppColor, height: 20, width: 20,),
                                                                                        color: whatsAppColor,
                                                                                      ),
                                                                          ...
                                                                          child: Text(
                                                                            (service[index]['members'][indexs]['mobile']).split(',')[1].trim(),
                                                                            style: GoogleFonts.secularOne(
                                                                                color: mobileText,
                                                                                fontSize: size.height * 0.02
                                                                            ),
                                                ...
                                                if(indexs < service[index]['members'].length - 1) const Divider(
                                                  thickness: 2,
                                                ),
                                              ],
                                            );
