...
class NovenaScreen extends StatefulWidget {
  const NovenaScreen({Key? key}) : super(key: key);
...
class _NovenaScreenState extends State<NovenaScreen> {
  ...
  getNovenaData() async {
    var request = http.Request('GET', Uri.parse('$baseUrl/prayer/services/Novena'));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        ) : novena.isNotEmpty ? SingleChildScrollView(
          child: ListView.builder(
            key: UniqueKey(),
            shrinkWrap: true,
            physics: const NeverScrollableScrollPhysics(),
            itemCount: novena.length, // Update the itemCount to 2 for two expansion tiles
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              novena[index]['name'] != '' && novena[index]['name'] != false ? Text(
                                novena[index]['name'],
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              novena[index]['day'] != '' && novena[index]['day'] != false ? Text(
                                novena[index]['day'],
                                style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),
                              ) : Text(
                                'NA',
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              novena[index]['from_time'] != '' && novena[index]['from_time'] != false || novena[index]['to_time'] != '' && novena[index]['to_time'] != false ? Row(
                                children: [
                                  if (novena[index]['from_time'] != '' && novena[index]['from_time'] != false) Text(
                                    novena[index]['from_time'],
                                    style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),
                                  ),
                                  if (novena[index]['from_time'] != '' && novena[index]['from_time'] != false && novena[index]['to_time'] != '' && novena[index]['to_time'] != false) Text(
                                    ' - ',
                                    style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),
                                  ),
                                  if (novena[index]['to_time'] != '' && novena[index]['to_time'] != false) Text(
                                    novena[index]['to_time'],
                                    style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),
                                  ),
                                ],
                              ) : Text(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              novena[index]['place'] != '' && novena[index]['place'] != false ? Row(
                                children: [
                                  if (novena[index]['community_id'] != '' && novena[index]['community_id'] != false) Text(
                                    novena[index]['community_id'],
                                    style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),
                                  ),
                                  if (novena[index]['community_id'] != '' && novena[index]['community_id'] != false) Text(
                                    ' - ',
                          ...
                          novena[index]['note'] != '' && novena[index]['note'] != false ? Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Flexible(
                                child: RichText(
