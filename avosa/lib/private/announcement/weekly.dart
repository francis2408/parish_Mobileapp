...
class _WeeklyScreenState extends State<WeeklyScreen> {
  ...
  getNewsData() async {
    var request = http.Request('GET', Uri.parse('$baseUrl/announcement/Weekly'));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        ) : weekly.isNotEmpty ? SingleChildScrollView(
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          weekly[index]['purpose'] != '' && weekly[index]['purpose'] != false ? Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Flexible(
                                child: Text(
                                  weekly[index]['purpose'],
                          ...
                          weekly[index]['description'] != '' && weekly[index]['description'] != false ? Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Flexible(
                                child: RichText(
