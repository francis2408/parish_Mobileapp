...
class SeasonalScreen extends StatefulWidget {
  const SeasonalScreen({Key? key}) : super(key: key);
...
class _SeasonalScreenState extends State<SeasonalScreen> {
  ...
  getNewsData() async {
    var request = http.Request('GET', Uri.parse('$baseUrl/announcement/Seasonal'));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        ) : seasonal.isNotEmpty ? SingleChildScrollView(
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          seasonal[index]['purpose'] != '' && seasonal[index]['purpose'] != false ? Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Flexible(
                                child: Text(
                                  seasonal[index]['purpose'],
                          ...
                          seasonal[index]['description'] != '' && seasonal[index]['description'] != false ? Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Flexible(
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                      ...
                                      children: [
                                        ...
                                        TextSpan(
                                          text: seasonal[index]['description'],
