...
class PublicGeneralScreen extends StatefulWidget {
  const PublicGeneralScreen({Key? key}) : super(key: key);

  @override
  State<PublicGeneralScreen> createState() => _PublicGeneralScreenState();
}

class _PublicGeneralScreenState extends State<PublicGeneralScreen> {
