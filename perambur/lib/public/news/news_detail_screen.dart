...
class NewsDetailsScreen extends StatefulWidget {
  ...
  const NewsDetailsScreen({Key? key, required this.title, required this.image, required this.date, required this.description}) : super(key: key);
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                const Icon(Icons.access_time, color: textHeadColor, size: 20,),
