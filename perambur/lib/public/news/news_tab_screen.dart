...
class PublicNewsTabScreen extends StatefulWidget {
  const PublicNewsTabScreen({Key? key}) : super(key: key);

  @override
  State<PublicNewsTabScreen> createState() => _PublicNewsTabScreenState();
}

class _PublicNewsTabScreenState extends State<PublicNewsTabScreen> with SingleTickerProviderStateMixin {
  late TabController _tabController;

  List tabs = ["Church", "General"] ;
  List<Widget> tabsContent = [
    const PublicChurchScreen(),
    const PublicGeneralScreen(),
  ];
