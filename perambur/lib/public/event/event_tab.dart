...
class PublicEventTabScreen extends StatefulWidget {
  const PublicEventTabScreen({Key? key}) : super(key: key);

  @override
  State<PublicEventTabScreen> createState() => _PublicEventTabScreenState();
}

class _PublicEventTabScreenState extends State<PublicEventTabScreen> with SingleTickerProviderStateMixin {
  late TabController _tabController;

  List tabs = ["This Week", "This Month", "All"];
  List<Widget> tabsContent = [
    const PublicAllEventScreen(),
    const PublicAllEventScreen(),
    const PublicAllEventScreen(),
  ];
