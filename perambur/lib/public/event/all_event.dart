...
class PublicAllEventScreen extends StatefulWidget {
  const PublicAllEventScreen({Key? key}) : super(key: key);

  @override
  State<PublicAllEventScreen> createState() => _PublicAllEventScreenState();
}

class _PublicAllEventScreenState extends State<PublicAllEventScreen> {
