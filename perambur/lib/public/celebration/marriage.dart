...
class PublicMarriageScreen extends StatefulWidget {
  const PublicMarriageScreen({Key? key}) : super(key: key);

  @override
  State<PublicMarriageScreen> createState() => _PublicMarriageScreenState();
}

class _PublicMarriageScreenState extends State<PublicMarriageScreen> {
  ...
  getObituaryData() async {
    var request = http.Request('GET', Uri.parse('$baseUrl/public/res.family/get_today_date_to_next_30_days_marriage_details'));
            ...
            child: Center(
              child: _isLoading ? SizedBox(
                ...
                children: [
                  ...
                  marriageData.isNotEmpty ? Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text('${marriageData.length}', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black),),
                  ...
                  marriageData.isNotEmpty ? Expanded(
                    child: SingleChildScrollView(
                      child: SlideFadeAnimation(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: marriageData.length,
                          itemBuilder: (BuildContext context, int index) {
                            final now = DateTime.now();
                            var todays = DateFormat('dd-MMMM').format(now);
                            DateTime date = DateFormat("dd-MMMM").parse(marriageData[index]['anniversary_day']);
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        GestureDetector(
                                          onTap: () {
                                            marriageData[index]['image'] != '' ? showDialog(
                                              context: context,
                                              builder: (BuildContext context) {
                                                return Dialog(
                                                  child: Image.network(marriageData[index]['image'], fit: BoxFit.cover,),
                                                );
                                              },
                                            ) : showDialog(
                                              context: context,
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              image: DecorationImage(
                                                fit: BoxFit.cover,
                                                image: marriageData[index]['image'] != null && marriageData[index]['image'] != ''
                                                    ? NetworkImage(marriageData[index]['image'])
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    Text(marriageData[index]['anniversary_day'], style: GoogleFonts.secularOne(color: blackColor, fontSize: size.height * 0.018),),
                                                  ],
                                                ),
                                                SizedBox(height: size.height * 0.01,),
                                                marriageData[index]['mobile'] != '' && marriageData[index]['mobile'] != null ? IntrinsicHeight(
                                                  child: (marriageData[index]['mobile']).split(',').length != 1 ? Row(
                                                    children: [
                                                      GestureDetector(
                                                        onTap: () {
                                                          showDialog(
                                                                ...
                                                                content: Row(
                                                                  ...
                                                                  children: [
                                                                    IconButton(
                                                                      onPressed: () {
                                                                        Navigator.pop(context);
                                                                        callAction((marriageData[index]['mobile']).split(',')[0].trim());
                                                                      },
                                                                    ...
                                                                    IconButton(
                                                                      onPressed: () {
                                                                        Navigator.pop(context);
                                                                        smsAction((marriageData[index]['mobile']).split(',')[0].trim());
                                                                      },
                                                                    ...
                                                                    IconButton(
                                                                      onPressed: () {
                                                                        Navigator.pop(context);
                                                                        whatsappAction((marriageData[index]['mobile']).split(',')[0].trim());
                                                                      },
                                                        ...
                                                        child: Text(
                                                          (marriageData[index]['mobile']).split(',')[0].trim(),
                                                      ...
                                                      GestureDetector(
                                                                ...
                                                                content: Row(
                                                                  ...
                                                                  children: [
                                                                    IconButton(
                                                                      onPressed: () {
                                                                        Navigator.pop(context);
                                                                        callAction((marriageData[index]['mobile']).split(',')[1].trim());
                                                                      },
                                                                      icon: const Icon(Icons.phone),
                                                                      color: callColor,
                                                                    ),
                                                                    IconButton(
                                                                      onPressed: () {
                                                                        Navigator.pop(context);
                                                                        smsAction((marriageData[index]['mobile']).split(',')[1].trim());
                                                                      },
                                                                      icon: const Icon(Icons.message),
                                                                      color: smsColor,
                                                                    ),
                                                                    IconButton(
                                                                      onPressed: () {
                                                                        Navigator.pop(context);
                                                                        whatsappAction((marriageData[index]['mobile']).split(',')[1].trim());
                                                                      },
                                                                      icon: SvgPicture.asset('assets/icons/whatsapp.svg', color: whatsAppColor, height: 20, width: 20,),
                                                                      color: whatsAppColor,
                                                                    ),
                                                        ...
                                                        child: Text(
                                                          (marriageData[index]['mobile']).split(',')[1].trim(),
                                                          style: GoogleFonts.secularOne(
                                                              color: mobileText,
                                                              fontSize: size.height * 0.02
                                                          ),),
