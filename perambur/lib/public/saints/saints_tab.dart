...
import 'today_saints_screen.dart';

class PublicSaintsTabScreen extends StatefulWidget {
  const PublicSaintsTabScreen({Key? key}) : super(key: key);

  @override
  State<PublicSaintsTabScreen> createState() => _PublicSaintsTabScreenState();
}

class _PublicSaintsTabScreenState extends State<PublicSaintsTabScreen> with SingleTickerProviderStateMixin {
  late TabController _tabController;

  List tabs = ["Today Saints", "All Saints"];

  List<Widget> tabsContent = [
    const PublicTodaySaintsScreen(),
    const PublicAllSaintsScreen(),
  ];
