...
class PublicGalleryScreen extends StatefulWidget {
  const PublicGalleryScreen({Key? key}) : super(key: key);
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                          onTap: () async {
                            ...
                            String refresh = await Navigator.push(context, CustomRoute(widget: PublicGalleryDetailScreen(title: '${galleryData[index]['name']}',)));
                            if(refresh == 'refresh') {
                              changeData();
                            }},
                          child: GridItem(
