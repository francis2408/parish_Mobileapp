...
class PublicSendPrayerRequest extends StatefulWidget {
  const PublicSendPrayerRequest({Key? key}) : super(key: key);

  @override
  State<PublicSendPrayerRequest> createState() => _PublicSendPrayerRequestState();
}

class _PublicSendPrayerRequestState extends State<PublicSendPrayerRequest> {
  ...
  pubilcPrayerRequest(String name, date, description) async {
    var request = http.Request('POST',  Uri.parse('$baseUrl/public/$parishID/parish_prayer_request'));
    request.body = json.encode({
      "params": {"name": name, "date": dates, "mobile": mobile, "email": email, "note": description, "type": "Non Parishioner"}
    });
  ...
  userPrayerRequest(String name, date, description) async {
    var request = http.Request('POST',  Uri.parse('$baseUrl/create/prayer.request'));
    request.body = json.encode({
      "params": {
        "data": {"name": name, "date": dates,"note": description, "type": "Parishioner", "parish_id": parishID, "create_uid": userId}
      }
    });
                        ...
                        if(titleController.text.isNotEmpty && dateController.text.isNotEmpty && descriptionController.text.isNotEmpty) {
                          if(isMobile == true && isEmail == true) {
                            ...
                            if(load) {
                              ...
                              isSignedIn ? userPrayerRequest(titleController.text.toString(), dateController.text.toString(), descriptionController.text.toString()) : pubilcPrayerRequest(titleController.text.toString(), dateController.text.toString(), descriptionController.text.toString());
                            }
                          }
                        } else {
                          setState(() {
