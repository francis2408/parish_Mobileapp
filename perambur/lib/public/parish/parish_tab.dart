...
class PublicParishTabScreen extends StatefulWidget {
  const PublicParishTabScreen({Key? key}) : super(key: key);

  @override
  State<PublicParishTabScreen> createState() => _PublicParishTabScreenState();
}

class _PublicParishTabScreenState extends State<PublicParishTabScreen> with SingleTickerProviderStateMixin {
  ...
  List<Widget> tabsContent = [
    const PublicParishDetailsScreen(),
    const PublicParishHistoryScreen(),
  ];
