...
class PublicObituaryScreen extends StatefulWidget {
  const PublicObituaryScreen({Key? key}) : super(key: key);

  @override
  State<PublicObituaryScreen> createState() => _PublicObituaryScreenState();
}

class _PublicObituaryScreenState extends State<PublicObituaryScreen> {
  ...
  getObituaryData() async {
    var request = http.Request('GET', Uri.parse('$baseUrl/public/member.death/get_today_date_to_next_30_days_death_details'));
