...
class PublicAssociationScreen extends StatefulWidget {
  const PublicAssociationScreen({Key? key}) : super(key: key);

  @override
  State<PublicAssociationScreen> createState() => _PublicAssociationScreenState();
}

class _PublicAssociationScreenState extends State<PublicAssociationScreen> {
