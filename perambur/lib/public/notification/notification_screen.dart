...
class PublicNotificationScreen extends StatefulWidget {
  const PublicNotificationScreen({Key? key}) : super(key: key);

  @override
  State<PublicNotificationScreen> createState() => _PublicNotificationScreenState();
}

class _PublicNotificationScreenState extends State<PublicNotificationScreen> {
