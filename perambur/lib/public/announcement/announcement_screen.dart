...
class PublicAnnouncementScreen extends StatefulWidget {
  const PublicAnnouncementScreen({Key? key}) : super(key: key);

  @override
  State<PublicAnnouncementScreen> createState() => _PublicAnnouncementScreenState();
}

class _PublicAnnouncementScreenState extends State<PublicAnnouncementScreen> {
  ...
  getNewsData() async {
    var request = http.Request('GET', Uri.parse('$baseUrl/public/$parishID/res.news'));
