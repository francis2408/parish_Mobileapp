                ...
                Card(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('Baptism', style: GoogleFonts.roboto(fontSize: size.height * 0.022, color: textHeadColor, fontWeight: FontWeight.w600),),
                ...
                Card(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('First Holy Communion', style: GoogleFonts.roboto(fontSize: size.height * 0.022, color: textHeadColor, fontWeight: FontWeight.w600),),
                        SizedBox(height: size.height * 0.01,),
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                ...
                Card(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Confirmation', style: GoogleFonts.roboto(fontSize: size.height * 0.022, color: textHeadColor, fontWeight: FontWeight.w600),),
                        SizedBox(height: size.height * 0.01,),
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                ...
                membersDetail['age'] != null && membersDetail['age'] != '' && membersDetail['age'] > 18 ? Card(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Marriage', style: GoogleFonts.roboto(fontSize: size.height * 0.022, color: textHeadColor, fontWeight: FontWeight.w600),),
                        SizedBox(height: size.height * 0.01,),
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
