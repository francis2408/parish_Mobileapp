...
import 'anbiyam_tab.dart';

class AnbiyamScreen extends StatefulWidget {
  const AnbiyamScreen({Key? key}) : super(key: key);

  @override
  State<AnbiyamScreen> createState() => _AnbiyamScreenState();
}

class _AnbiyamScreenState extends State<AnbiyamScreen> {
