...
class _BirthdayScreenState extends State<BirthdayScreen> {
  ...
  getObituaryData() async {
    var request = http.Request('GET', Uri.parse('$baseUrl/res.member/get_today_date_to_next_30_days_birthday_details'));
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              borderRadius: BorderRadius.circular(10),
                                              boxShadow: <BoxShadow>[
                                                if (birthData[index]['image'] == null && birthData[index]['image'] == '') const BoxShadow(
                                                  color: Colors.grey,
                                                  spreadRadius: -1,
                                                  blurRadius: 5 ,
                                                  offset: Offset(0, 1),
