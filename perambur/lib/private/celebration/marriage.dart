...
class _MarriageScreenState extends State<MarriageScreen> {
  ...
  getObituaryData() async {
    var request = http.Request('GET', Uri.parse('$baseUrl/res.family/get_today_date_to_next_30_days_marriage_details'));
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              borderRadius: BorderRadius.circular(10),
                                              boxShadow: <BoxShadow>[
                                                if (marriageData[index]['image'] == null && marriageData[index]['image'] == '') const BoxShadow(
                                                  color: Colors.grey,
                                                  spreadRadius: -1,
                                                  blurRadius: 5 ,
                                                  offset: Offset(0, 1),
