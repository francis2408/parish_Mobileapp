  ...
  getParishData() async {
    ...
    request.body = json.encode({
      "params": {
        "filter": "[['id','=',$parishID]]",
        "access_all": "1",
        "query": "{name,image_1920,parish_logo,establishment_date,patron_id,vicariate_id,priest_id{image_1920,member_name,mobile,role_ids},street,street2,city,district_id,state_id,country_id,zip,mobile,phone,email,website,youtube,livestream,google_link,common_link,history}"
      }
    });
                                            ...
                                            child: Text.rich(
                                              ...
                                              TextSpan(
                                                  ...
                                                  children: [
                                                    ...
                                                    TextSpan(
                                                      text: parish[index]['priest_id']['role_ids_view'] != null && parish[index]['priest_id']['role_ids_view'] != '' ? '(${parish[index]['priest_id']['role_ids_view']})' : '(Parish Priest)',
                                                      style: GoogleFonts.secularOne(
